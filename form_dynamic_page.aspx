                        ...
                        <div class="jarviswidget " id="wid-id-0" data-widget-sortable="false" data-widget-deletebutton="false" data-widget-togglebutton="false" data-widget-editbutton="false">
                            ...
                            <div>
                                ...
                                <div class="widget-body">
                                    ...
                                    <asp:CheckBox runat="server" ID="chkDetailReq" Text="Detail Repeater Required" AutoPostBack="true" OnCheckedChanged="chkDetailReq_CheckedChanged" />
                                    <fieldset>
                                        <div>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:DropDownList runat="server" ID="ddlControlType" AutoPostBack="true" OnSelectedIndexChanged="ddlControlType_SelectedIndexChanged" AppendDataBoundItems="true">
                                                                ...
                                                                <asp:ListItem Text="File Upload" Value="10"></asp:ListItem>
                                                            </asp:DropDownList>
                                                        </td>
                                                        <td>
                                    ...
                                    <fieldset id="field_detail_req" runat="server" visible="false">
                                        <div runat="server" id="Div1" visible="true">
                                            <label style="float: left; margin-left: 10px;">Table Name</label>
                                            <div style="float: left; margin-left: 10px;">
                                                <asp:TextBox ID="txt_tbl_name1_detail" Width="350" runat="server" CssClass="form-control" ClientIDMode="AutoID" Placeholder="Type and select" AutoPostBack="true" OnTextChanged="txt_tbl_name1_detail_TextChanged">
                                                </asp:TextBox>
                                                <ajaxToolkit:AutoCompleteExtender FirstRowSelected="true" ID="AutoCompleteExtender2" runat="server" ServicePath="~/Web_Service.asmx"
                                                    ServiceMethod="get_tbl_name1" TargetControlID="txt_tbl_name1_detail" MinimumPrefixLength="1" ClientIDMode="AutoID"
                                                    CompletionListCssClass="listMain" EnableCaching="false" CompletionListHighlightedItemCssClass="itemsSelected"
                                                    CompletionListItemCssClass="itemsMain" UseContextKey="true" ContextKey="0" OnClientPopulating="SetContextKey">
                                                </ajaxToolkit:AutoCompleteExtender>
                                            </div>
                                        ...
                                        <div>
                                            <label style="float: left; margin-left: 10px;">Table Name</label>
                                            <div style="float: left; margin-left: 10px;">
                                                <asp:DropDownList Width="350" CssClass="form-control" AutoPostBack="true" ID="ddlTable_detail" runat="server"
                                                    AppendDataBoundItems="true"
                                                    OnSelectedIndexChanged="ddlTable_detail_SelectedIndexChanged">
                                                    <asp:ListItem Value="0">Select Table</asp:ListItem>
                                                </asp:DropDownList>
                                                <span class="red_star">*</span>
                                                <asp:RequiredFieldValidator CssClass="error_messe" ID="RequiredFieldValidator3" Display="dynamic"
                                                    runat="server" ErrorMessage="Please select table" InitialValue="0" ControlToValidate="ddlTable_detail"></asp:RequiredFieldValidator>
                                            </div>
                                        </div>
                                        <div style="clear: both; float: none; width: auto;"></div>

                                        <div>
                                            <asp:Repeater ID="RptFieldDetail" runat="server">
                                                <HeaderTemplate>
                                                    <table border="1" cellpadding="0" cellspacing="0" style="border-color: Black;">
                                                        <tr style="font-family: cambria; background-color: Gray; font-size: 15px; font-style: italic; font-weight: 700; text-align: center;">
                                                            <td colspan="16">Field Info of selected table </td>
                                                ...
                                                <ItemTemplate>
                                                    <tr>
                                                        <td><asp:CheckBox runat="server" ID="chkIsForeignColumn" AutoPostBack="true" OnCheckedChanged="chkIsForeignColumn_CheckedChanged" /></td>
                                                        <td><%#DataBinder.Eval(Container,"DataItem.Name")%></td>
                                                        <asp:HiddenField ID="hid_fnm" runat="server" Value='<%#DataBinder.Eval(Container,"DataItem.Name")%>' />
                                                        <td><%#DataBinder.Eval(Container,"DataItem.datatype")%></td>
                                                        <asp:HiddenField ID="hid_datatype" runat="server" Value='<%#DataBinder.Eval(Container,"DataItem.datatype")%>' />
                                                        ...
                                                        <td>
                                                            <asp:DropDownList runat="server" ID="ddlControlType" AutoPostBack="true" OnSelectedIndexChanged="ddlControlType_SelectedIndexChanged" AppendDataBoundItems="true">
                                                                <asp:ListItem Text="Select Control Type" Value="0"></asp:ListItem>
                                                                <asp:ListItem Text="HiddenField" Value="9"></asp:ListItem>
                                                                <asp:ListItem Text="TextBox(String)" Value="1"></asp:ListItem>
                                                                <asp:ListItem Text="TextBox(Multiline)" Value="2"></asp:ListItem>
                                                                <asp:ListItem Text="TextBox(Numeric)" Value="3"></asp:ListItem>
                                                                <asp:ListItem Text="TextBox(DateTime)" Value="4"></asp:ListItem>
                                        ...
                                        <div id="div2" runat="server" class="msgclass">
                                            <table style="text-align: left;">
                                                <tr>
                                                    <td>
                                                        <asp:CheckBox ID="chk_ltbl_detail" runat="server"
                                                            Text="Create Log Table" />
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                        <asp:CheckBox ID="chkSynonym_detail" runat="server"
                                                            Text="Create Log Table Synonym" />
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                        <asp:CheckBox runat="server" ID="chk_ltgr_detail" Text="Create Trigger" />
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                        <label>
                                                            <asp:CheckBox runat="server" ID="chk_spcreate_detail"
                                                                Text="Create Procedure for Insert with name" AutoPostBack="true"
                                                                OnCheckedChanged="chk_spcreate_CheckedChanged" />
                                                            </lable>
                                                            <asp:TextBox ID="txt_spcreate_detail" runat="server" BorderStyle="None" Width="400"></asp:TextBox>

                                                            <label id="lblwebmethod_detail" runat="server" visible="false">
                                                                <asp:CheckBox runat="server" ID="chk_spwebmethod_detail"
                                                                    Text="Create Procedure for Insert Web method" AutoPostBack="true" /></label>
                                                            <asp:TextBox ID="txt_spwebmethod_detail" runat="server" BorderStyle="None" Width="400"></asp:TextBox>
                                                    </td>
                                                ...
                                                <tr>
                                                    <td>
                                                        <asp:CheckBox runat="server" ID="chk_spdelete_detail"
                                                            Text="Create Procedure for Delete with name" />
                                                        <asp:TextBox ID="txt_spdelete_detail" runat="server" BorderStyle="None" Width="400"></asp:TextBox>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                        <asp:CheckBox runat="server" ID="chk_spupdate_detail"
                                                            Text="Create Procedure for Update with name" />
                                                        <asp:TextBox ID="txt_spupdate_detail" runat="server" BorderStyle="None" Width="400"></asp:TextBox>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                        <asp:CheckBox runat="server" ID="chk_spselbyid_detail"
                                                            Text="Create Procedure for select by id with name" />
                                                        <asp:TextBox ID="txt_spselbyid_detail" runat="server" BorderStyle="None" Width="400"></asp:TextBox>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                        <asp:CheckBox runat="server" ID="chk_spselall_detail"
                                                            Text="Create Procedure for Select all with name" />
                                                        <asp:TextBox ID="txt_spselall_detail" runat="server" BorderStyle="None" Width="400"></asp:TextBox>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                        <asp:CheckBox runat="server" ID="chk_spsellist_detail"
                                                            Text="Create Procedure for select with name" />
                                                        <asp:TextBox ID="txt_spsellist_detail" runat="server" BorderStyle="None" Width="400"></asp:TextBox>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                        <asp:CheckBox runat="server" ID="chk_splogsellist_detail"
                                                            Text="Create Procedure for log select with name" />
                                                        <asp:TextBox ID="txt_splogsellist_detail" runat="server" BorderStyle="None" Width="400"></asp:TextBox>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                        <asp:CheckBox runat="server" ID="chk_spdellogsellist_detail"
                                                            Text="Create Procedure for deleted log select with name" />
                                                        <asp:TextBox ID="txt_spdellogsellist_detail" runat="server" BorderStyle="None" Width="400"></asp:TextBox>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                        <asp:CheckBox runat="server" ID="chk_fileprop_detail" Text="Create PROPERTY File with name" />
                                                        <asp:TextBox ID="txt_fileprop_detail" runat="server" BorderStyle="None" Width="400"></asp:TextBox>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                        <asp:CheckBox runat="server" ID="chk_filedb_detail"
                                                            Text="Create DB Function File with name" />
                                                        <asp:TextBox ID="txt_filedb_detail" runat="server" BorderStyle="None" Width="400"></asp:TextBox>
                                                    </td>
                                                </tr>
