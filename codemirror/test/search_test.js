(function() {
  ...
  test("simple", function() {
    var doc = new VIKALP.Doc("abcdefg\nabcdefg")
    run(doc, "cde", false, 0, 2, 0, 5, 1, 2, 1, 5);
  });

  test("multiline", function() {
    var doc = new VIKALP.Doc("hallo\na\nb\ngoodbye")
    run(doc, "llo\na\nb\ngoo", false, 0, 2, 3, 3);
    run(doc, "blah\na\nb\nhall", false);
    run(doc, "bye\nx\neye", false);
  });
  ...
  test("regexpMultiline", function() {
    var doc = new VIKALP.Doc("fom fom\nbar\nbaz")
  ...
  test("multilineInsensitive", function() {
    var doc = new VIKALP.Doc("zie ginds komT\nDe Stoomboot\nuit Spanje weer aan")
    run(doc, "komt\nde stoomboot\nuit", false);
  ...
  test("expandingCaseFold", function() {
    var doc = new VIKALP.Doc("<b>İİ İİ</b>\n<b>uu uu</b>")
  ...
  test("normalize", function() {
    ...
    var doc = new VIKALP.Doc("yılbaşı\n수 있을까\nLe taux d'humidité à London")
