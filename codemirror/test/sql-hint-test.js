...
(function() {
  ...
  function test(name, spec) {
    testCM(name, function(cm) {
      ...
      var completion = VIKALP.hint.sql(cm, {
        tables: spec.tables,
  ...
  test("keywords", {
    value: "SEL",
    cursor: Pos(0, 3),
    list: [{"text":"SELECT","className":"VIKALP-hint-keyword"}],
    from: Pos(0, 0),
    to: Pos(0, 3)
  });
  ...
  test("from", {
    value: "SELECT * fr",
    cursor: Pos(0, 11),
    list: [{"text":"FROM","className":"VIKALP-hint-keyword"}],
    from: Pos(0, 9),
    to: Pos(0, 11)
  });
  ...
  test("table", {
    ...
    cursor: Pos(0, 9),
    tables: simpleTables,
    list: [{"text":"xcountries","className":"VIKALP-hint-table"}],
    from: Pos(0, 7),
    to: Pos(0, 9)
  });
  ...
  test("schema", {
    ...
    cursor: Pos(0, 12),
    tables: schemaTables,
    list: [{"text":"schema.users","className":"VIKALP-hint-table"},
        {"text":"schema.countries","className":"VIKALP-hint-table"},
        {"text":"SCHEMA","className":"VIKALP-hint-keyword"},
        {"text":"SCHEMA_NAME","className":"VIKALP-hint-keyword"},
        {"text":"SCHEMAS","className":"VIKALP-hint-keyword"}],
    from: Pos(0, 7),
    to: Pos(0, 12)
  });
    ...
    list: [
      {
        ...
        columnName: "alias",
        columnHint: "varchar(255) | Primary",
        className: "VIKALP-hint-table VIKALP-hint-default-table"
      },
      { text: "Api__TokenAliases", className: "VIKALP-hint-table" }
    ],
    from: Pos(0, 7),
    to: Pos(0, 8)
  });
  ...
  test("displayText_table", {
    ...
    list: [{text: "mytable", displayText: "mytable | The main table", "className":"VIKALP-hint-table"}],
    from: Pos(0, 7),
    to: Pos(0, 10)
  });
