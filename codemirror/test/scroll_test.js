(function() {
  ...
  function barH(cm) { return byClassName(cm.getWrapperElement(), "VIKALP-hscrollbar")[0]; }
  function barV(cm) { return byClassName(cm.getWrapperElement(), "VIKALP-vscrollbar")[0]; }
