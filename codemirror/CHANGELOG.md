...
[search addon](https://VIKALP.net/5/demo/search.html): Make it possible to configure the search addon to show the dialog at the bottom of the editor.
...
[pascal mode](https://VIKALP.net/5/mode/pascal/index.html): Recognize curly bracket comments.
...
[vim bindings](https://VIKALP.net/5/demo/vim.html): Improve EOL handling.
...
[asterisk mode](https://VIKALP.net/5/mode/asterisk/): Improve comment support.
...
[swift mode](https://VIKALP.net/5/mode/swift): Support multi-line strings.
...
[panel addon](https://VIKALP.net/5/doc/manual.html#addon_panel): Fix problem where replacing the last remaining panel dropped the newly added panel.
...
[javascript mode](https://VIKALP.net/5/mode/javascript/): Support block scopes, bindingless catch, bignum suffix, `s` regexp flag.
...
[markdown mode](https://VIKALP.net/5/mode/markdown/): Fix a regexp with potentially exponental complexity.
...
[shell mode](https://VIKALP.net/5/mode/shell/): Better handling of nested quoting.
...
[searchcursor addon](https://VIKALP.net/5/doc/manual.html#addon_searchcursor): Support multi-line regular expression matches, and normalize strings when matching.
...
[python mode](https://VIKALP.net/5/mode/python/): Support underscores in number literals.
...
The [`heightAtLine`](https://VIKALP.net/5/doc/manual.html#heightAtLine) method now takes an extra argument to allow finding the height at the top of the line's line widgets.
...
[dylan mode](https://VIKALP.net/5/mode/dylan/index.html): Several improvements and fixes.
...
* New modes: [Vue](https://VIKALP.net/5/mode/vue/index.html), [Oz](https://VIKALP.net/5/mode/oz/index.html), [MscGen](https://VIKALP.net/5/mode/mscgen/index.html) (and dialects), [Closure Stylesheets](https://VIKALP.net/5/mode/css/gss.html)
...
*   Further improvements to the [vim mode](https://VIKALP.net/5/demo/vim.html).
...
*   New modes: [Turtle](https://VIKALP.net/5/mode/turtle/index.html) and [Q](https://VIKALP.net/5/mode/q/index.html).
*   Further improvements to the [vim mode](https://VIKALP.net/5/demo/vim.html).
*   Full [list of patches](https://github.com/VIKALP/VIKALP/compare/v3.01...v3.1).

## 3.0.0 (2012-12-10)

**New major version**. Only partially backwards-compatible. See the [upgrading guide](https://VIKALP.net/5/doc/upgrade_v3.html) for more information. Changes since release candidate 2:

*   Rewritten VIM mode.
*   Fix a few minor scrolling and sizing issues.
*   Work around Safari segfault when dragging.
*   Full [list of patches](https://github.com/VIKALP/VIKALP/compare/v3.0rc2...v3.0).

## 2.38.0 (2013-01-21)

Integrate some bugfixes, enhancements to the vim keymap, and new modes ([D](https://VIKALP.net/5/mode/d/index.html), [Sass](https://VIKALP.net/5/mode/sass/index.html), [APL](https://VIKALP.net/5/mode/apl/index.html)) from the v3 branch.

## 2.37.0 (2012-12-20)

*   New mode: [SQL](https://VIKALP.net/5/mode/sql/index.html) (will replace [plsql](https://VIKALP.net/5/mode/plsql/index.html) and [mysql](https://VIKALP.net/5/mode/mysql/index.html) modes).
*   Further work on the new VIM mode.
*   Fix Cmd/Ctrl keys on recent Operas on OS X.
*   Full [list of patches](https://github.com/VIKALP/VIKALP/compare/v2.36...v2.37).

## 2.36.0 (2012-11-20)

*   New mode: [Z80 assembly](https://VIKALP.net/5/mode/z80/index.html).
*   New theme: [Twilight](https://VIKALP.net/5/demo/theme.html#twilight).
*   Add command-line compression helper.
*   Make [`scrollIntoView`](https://VIKALP.net/5/doc/manual.html#scrollIntoView) public.
*   Add [`defaultTextHeight`](https://VIKALP.net/5/doc/manual.html#defaultTextHeight) method.
*   Various extensions to the vim keymap.
*   Make [PHP mode](https://VIKALP.net/5/mode/php/index.html) build on [mixed HTML mode](https://VIKALP.net/5/mode/htmlmixed/index.html).
*   Add [comment-continuing](https://VIKALP.net/5/doc/manual.html#addon_continuecomment) add-on.
*   Full [list of patches](https://VIKALP.net/5/https://github.com/VIKALP/VIKALP/compare/v2.35...v2.36).

## 2.35.0 (2012-10-22)

*   New (sub) mode: [TypeScript](https://VIKALP.net/5/mode/javascript/typescript.html).
*   Don't overwrite (insert key) when pasting.
*   Fix several bugs in [`markText`](https://VIKALP.net/5/doc/manual.html#markText)/undo interaction.
*   Better indentation of JavaScript code without semicolons.
*   Add [`defineInitHook`](https://VIKALP.net/5/doc/manual.html#defineInitHook) function.
*   Full [list of patches](https://github.com/VIKALP/VIKALP/compare/v2.34...v2.35).

## 2.34.0 (2012-09-19)

*   New mode: [Common Lisp](https://VIKALP.net/5/mode/commonlisp/index.html).
...
*   Add a [`VIKALP.version`](https://VIKALP.net/5/doc/manual.html#version) property.
*   More robust handling of nested modes in [formatting](https://VIKALP.net/5/demo/formatting.html) and [closetag](https://VIKALP.net/5/demo/closetag.html) plug-ins.
*   Un/redo now preserves [marked text](https://VIKALP.net/5/doc/manual.html#markText) and bookmarks.
*   [Full list](https://github.com/VIKALP/VIKALP/compare/v2.33...v2.34) of patches.

## 2.33.0 (2012-08-23)

*   New mode: [Sieve](https://VIKALP.net/5/mode/sieve/index.html).
*   New [`getViewPort`](https://VIKALP.net/5/doc/manual.html#getViewport) and [`onViewportChange`](https://VIKALP.net/5/doc/manual.html#option_onViewportChange) API.
*   [Configurable](https://VIKALP.net/5/doc/manual.html#option_cursorBlinkRate) cursor blink rate.
*   Make binding a key to `false` disabling handling (again).
*   Show non-printing characters as red dots.
*   More tweaks to the scrolling model.
*   Expanded testsuite. Basic linter added.
*   Remove most uses of `innerHTML`. Remove `VIKALP.htmlEscape`.
*   [Full list](https://github.com/VIKALP/VIKALP/compare/v2.32...v2.33) of patches.
...
*   New modes: [OCaml](https://VIKALP.net/5/mode/ocaml/index.html), [Haxe](https://VIKALP.net/5/mode/haxe/index.html), and [VB.NET](https://VIKALP.net/5/mode/vb/index.html).
*   Several fixes to the new scrolling model.
*   Add a [`setSize`](https://VIKALP.net/5/doc/manual.html#setSize) method for programmatic resizing.
*   Add [`getHistory`](https://VIKALP.net/5/doc/manual.html#getHistory) and [`setHistory`](https://VIKALP.net/5/doc/manual.html#setHistory) methods.
*   Allow custom line separator string in [`getValue`](https://VIKALP.net/5/doc/manual.html#getValue) and [`getRange`](https://VIKALP.net/5/doc/manual.html#getRange).
*   Support double- and triple-click drag, double-clicking whitespace.
*   And more... [(all patches)](https://github.com/VIKALP/VIKALP/compare/v2.3...v2.31)

## 2.30.0 (2012-06-22)

*   **New scrollbar implementation**. Should flicker less. Changes DOM structure of the editor.
*   New theme: [vibrant-ink](https://VIKALP.net/5/demo/theme.html#vibrant-ink).
*   Many extensions to the VIM keymap (including text objects).
*   Add [mode-multiplexing](https://VIKALP.net/5/demo/multiplex.html) utility script.
*   Fix bug where right-click paste works in read-only mode.
*   Add a [`getScrollInfo`](https://VIKALP.net/5/doc/manual.html#getScrollInfo) method.
*   Lots of other [fixes](https://github.com/VIKALP/VIKALP/compare/v2.25...v2.3).

## 2.25.0 (2012-05-23)

*   New mode: [Erlang](https://VIKALP.net/5/mode/erlang/index.html).
*   **Remove xmlpure mode** (use [xml.js](https://VIKALP.net/5/mode/xml/index.html)).
...
*   New modes: [Shell](https://VIKALP.net/5/mode/shell/index.html), [Tiki wiki](https://VIKALP.net/5/mode/tiki/index.html), [Pig Latin](https://VIKALP.net/5/mode/pig/index.html).
*   New themes: [Ambiance](https://VIKALP.net/5/demo/theme.html#ambiance), [Blackboard](https://VIKALP.net/5/demo/theme.html#blackboard).
*   More control over drag/drop with [`dragDrop`](https://VIKALP.net/5/doc/manual.html#option_dragDrop) and [`onDragEvent`](https://VIKALP.net/5/doc/manual.html#option_onDragEvent) options.
*   Make HTML mode a bit less pedantic.
*   Add [`compoundChange`](https://VIKALP.net/5/doc/manual.html#compoundChange) API method.
...
*   New modes: [XQuery](https://VIKALP.net/5/mode/xquery/index.html) and [VBScript](https://VIKALP.net/5/mode/vbscript/index.html).
*   Two new themes: [lesser-dark](https://VIKALP.net/5/mode/less/index.html) and [xq-dark](https://VIKALP.net/5/mode/xquery/index.html).
*   Differentiate between background and text styles in [`setLineClass`](https://VIKALP.net/5/doc/manual.html#setLineClass).
*   Fix drag-and-drop in IE9+.
*   Extend [`charCoords`](https://VIKALP.net/5/doc/manual.html#charCoords) and [`cursorCoords`](https://VIKALP.net/5/doc/manual.html#cursorCoords) with a `mode` argument.
*   Add [`autofocus`](https://VIKALP.net/5/doc/manual.html#option_autofocus) option.
*   Add [`findMarksAt`](https://VIKALP.net/5/doc/manual.html#findMarksAt) method.

## 2.22.0 (2012-02-27)

*   Allow [key handlers](https://VIKALP.net/5/doc/manual.html#keymaps) to pass up events, allow binding characters.
*   Add [`autoClearEmptyLines`](https://VIKALP.net/5/doc/manual.html#option_autoClearEmptyLines) option.
*   Properly use tab stops when rendering tabs.
*   Make PHP mode more robust.
*   Support indentation blocks in [code folder](https://VIKALP.net/5/doc/manual.html#addon_foldcode).
*   Add a script for [highlighting instances of the selection](https://VIKALP.net/5/doc/manual.html#addon_match-highlighter).
*   New [.properties](https://VIKALP.net/5/mode/properties/index.html) mode.
*   Fix many bugs.

## 2.21.0 (2012-01-27)

*   Added [LESS](https://VIKALP.net/5/mode/less/index.html), [MySQL](https://VIKALP.net/5/mode/mysql/index.html), [Go](https://VIKALP.net/5/mode/go/index.html), and [Verilog](https://VIKALP.net/5/mode/verilog/index.html) modes.
*   Add [`smartIndent`](https://VIKALP.net/5/doc/manual.html#option_smartIndent) option.
*   Support a cursor in [`readOnly`](https://VIKALP.net/5/doc/manual.html#option_readOnly)-mode.
*   Support assigning multiple styles to a token.
*   Use a new approach to drawing the selection.
*   Add [`scrollTo`](https://VIKALP.net/5/doc/manual.html#scrollTo) method.
*   Allow undo/redo events to span non-adjacent lines.
*   Lots and lots of bugfixes.

## 2.20.0 (2011-12-20)

*   Slightly incompatible API changes. Read [this](https://VIKALP.net/5/doc/upgrade_v2.2.html).
*   New approach to [binding](https://VIKALP.net/5/doc/manual.html#option_extraKeys) keys, support for [custom bindings](https://VIKALP.net/5/doc/manual.html#option_keyMap).
*   Support for overwrite (insert).
*   [Custom-width](https://VIKALP.net/5/doc/manual.html#option_tabSize) and [styleable](https://VIKALP.net/5/demo/visibletabs.html) tabs.
*   Moved more code into [add-on scripts](https://VIKALP.net/5/doc/manual.html#addons).
*   Support for sane vertical cursor movement in wrapped lines.
*   More reliable handling of editing [marked text](https://VIKALP.net/5/doc/manual.html#markText).
*   Add minimal [emacs](https://VIKALP.net/5/demo/emacs.html) and [vim](https://VIKALP.net/5/demo/vim.html) bindings.
*   Rename `coordsFromIndex` to [`posFromIndex`](https://VIKALP.net/5/doc/manual.html#posFromIndex), add [`indexFromPos`](https://VIKALP.net/5/doc/manual.html#indexFromPos) method.
...
*   Add support for [line wrapping](https://VIKALP.net/5/doc/manual.html#option_lineWrapping) and [code folding](https://VIKALP.net/5/doc/manual.html#hideLine).
*   Add [GitHub-style Markdown](https://VIKALP.net/5/mode/gfm/index.html) mode.
*   Add [Monokai](https://VIKALP.net/5/theme/monokai.css) and [Rubyblue](https://VIKALP.net/5/theme/rubyblue.css) themes.
*   Add [`setBookmark`](https://VIKALP.net/5/doc/manual.html#setBookmark) method.
*   Move some of the demo code into reusable components under [`lib/util`](https://VIKALP.net/5/addon/).
...
*   Add [Perl](https://VIKALP.net/5/mode/perl/index.html), [Rust](https://VIKALP.net/5/mode/rust/index.html), [TiddlyWiki](https://VIKALP.net/5/mode/tiddlywiki/index.html), and [Groovy](https://VIKALP.net/5/mode/groovy/index.html) modes.
*   Dragging text inside the editor now moves, rather than copies.
*   Add a [`coordsFromIndex`](https://VIKALP.net/5/doc/manual.html#coordsFromIndex) method.
*   **API change**: `setValue` now no longer clears history. Use [`clearHistory`](https://VIKALP.net/5/doc/manual.html#clearHistory) for that.
*   **API change**: [`markText`](https://VIKALP.net/5/doc/manual.html#markText) now returns an object with `clear` and `find` methods. Marked text is now more robust when edited.
...
*   Add [Clojure](https://VIKALP.net/5/mode/clojure/index.html), [Pascal](https://VIKALP.net/5/mode/pascal/index.html), [NTriples](https://VIKALP.net/5/mode/ntriples/index.html), [Jinja2](https://VIKALP.net/5/mode/jinja2/index.html), and [Markdown](https://VIKALP.net/5/mode/markdown/index.html) modes.
*   Add [Cobalt](https://VIKALP.net/5/theme/cobalt.css) and [Eclipse](https://VIKALP.net/5/theme/eclipse.css) themes.
*   Add a [`fixedGutter`](https://VIKALP.net/5/doc/manual.html#option_fixedGutter) option.
...
*   Add [Ruby](https://VIKALP.net/5/mode/ruby/index.html), [R](https://VIKALP.net/5/mode/r/index.html), [CoffeeScript](https://VIKALP.net/5/mode/coffeescript/index.html), and [Velocity](https://VIKALP.net/5/mode/velocity/index.html) modes.
*   Add [`getGutterElement`](https://VIKALP.net/5/doc/manual.html#getGutterElement) to API.
*   Several fixes to scrolling and positioning.
*   Add [`smartHome`](https://VIKALP.net/5/doc/manual.html#option_smartHome) option.
*   Add an experimental [pure XML](https://VIKALP.net/5/mode/xmlpure/index.html) mode.

## 2.12.0 (2011-07-25)

*   Add a [SPARQL](https://VIKALP.net/5/mode/sparql/index.html) mode.
...
*   Add a [Scheme mode](https://VIKALP.net/5/mode/scheme/index.html).
*   Add a `replace` method to search cursors, for cursor-preserving replacements.
*   Make the [C-like mode](https://VIKALP.net/5/mode/clike/index.html) mode more customizable.
*   Update XML mode to spot mismatched tags.
*   Add `getStateAfter` API and `compareState` mode API methods for finer-grained mode magic.
*   Add a `getScrollerElement` API method to manipulate the scrolling DIV.
*   Fix drag-and-drop for Firefox.
*   Add a C# configuration for the [C-like mode](https://VIKALP.net/5/mode/clike/index.html).
*   Add [full-screen editing](https://VIKALP.net/5/demo/fullscreen.html) and [mode-changing](https://VIKALP.net/5/demo/changemode.html) demos.

## 2.10.0 (2011-06-07)

Add a [theme](https://VIKALP.net/5/doc/manual.html#option_theme) system ([demo](https://VIKALP.net/5/demo/theme.html)). Note that this is not backwards-compatible—you'll have to update your styles and modes!

## 2.2.0 (2011-06-07)

*   Add a [Lua mode](https://VIKALP.net/5/mode/lua/index.html).
*   Fix reverse-searching for a regexp.
*   Empty lines can no longer break highlighting.
*   Rework scrolling model (the outer wrapper no longer does the scrolling).
*   Solve horizontal jittering on long lines.
*   Add [runmode.js](https://VIKALP.net/5/demo/runmode.html).
*   Immediately re-highlight text when typing.
*   Fix problem with 'sticking' horizontal scrollbar.

## 2.1.0 (2011-05-26)

*   Add a [Smalltalk mode](https://VIKALP.net/5/mode/smalltalk/index.html).
*   Add a [reStructuredText mode](https://VIKALP.net/5/mode/rst/index.html).
*   Add a [Python mode](https://VIKALP.net/5/mode/python/index.html).
*   Add a [PL/SQL mode](https://VIKALP.net/5/mode/plsql/index.html).
...
VIKALP 2 is a complete rewrite that's faster, smaller, simpler to use, and less dependent on browser quirks. See [this](https://VIKALP.net/5/doc/internals.html) and [this](http://groups.google.com/group/VIKALP/browse_thread/thread/5a8e894024a9f580) for more information.
