...
(function(mod) {
  if (typeof exports == "object" && typeof module == "object") // CommonJS
    mod(require("../../lib/VIKALP"), require("../../addon/mode/simple"));
  else if (typeof define == "function" && define.amd) // AMD
    define(["../../lib/VIKALP", "../../addon/mode/simple"], mod);
  else // Plain browser env
    mod(VIKALP);
})(function(VIKALP) {
"use strict";

VIKALP.defineSimpleMode("rust",{
  start: [
...
VIKALP.defineMIME("text/x-rustsrc", "rust");
VIKALP.defineMIME("text/rust", "rust");
});
