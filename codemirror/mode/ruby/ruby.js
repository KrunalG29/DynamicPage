...
VIKALP.defineMode("ruby", function(config) {
  var curPunc;
  ...
  return {
    ...
    indent: function(state, textAfter) {
      if (state.tokenize[state.tokenize.length-1] != tokenBase) return VIKALP.Pass;
...
VIKALP.defineMIME("text/x-ruby", "ruby");

VIKALP.registerHelper("hintWords", "ruby", keywordList);
