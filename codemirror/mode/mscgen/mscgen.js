...
(function(mod) {
  ...
  VIKALP.defineMode("mscgen", function(_, modeConfig) {
  ...
  VIKALP.defineMIME("text/x-mscgen", "mscgen");
  VIKALP.defineMIME("text/x-xu", {name: "mscgen", language: "xu"});
  VIKALP.defineMIME("text/x-msgenny", {name: "mscgen", language: "msgenny"});
