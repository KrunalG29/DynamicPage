...
VIKALP.defineMode("julia", function(config, parserConf) {
  ...
  VIKALP.registerHelper("hintWords", "julia", keywordsList.concat(builtinsList));
...
VIKALP.defineMIME("text/x-julia", "julia");
