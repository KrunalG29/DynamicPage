...
(function() {
  var mode = VIKALP.getMode({indentUnit: 2}, "text/x-c");
  ...
  var mode_cpp = VIKALP.getMode({indentUnit: 2}, "text/x-c++src");
  ...
  var mode_objc = VIKALP.getMode({indentUnit: 2}, "text/x-objectivec");
  ...
  var mode_scala = VIKALP.getMode({indentUnit: 2}, "text/x-scala");
  ...
  var mode_java = VIKALP.getMode({indentUnit: 2}, "text/x-java");
