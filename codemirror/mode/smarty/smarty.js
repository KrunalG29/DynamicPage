...
(function(mod) {
  ...
  VIKALP.defineMode("smarty", function(config, parserConf) {
    var rightDelimiter = parserConf.rightDelimiter || "}";
    var leftDelimiter = parserConf.leftDelimiter || "{";
    var version = parserConf.version || 2;
    var baseMode = VIKALP.getMode(config, parserConf.baseMode || "null");
    ...
    return {
      startState: function() {
        return {
          base: VIKALP.startState(baseMode),
          tokenize: tokenTop,
          last: null,
          depth: 0
        };
      ...
      copyState: function(state) {
        return {
          base: VIKALP.copyState(baseMode, state.base),
  ...
  VIKALP.defineMIME("text/x-smarty", "smarty");
});
