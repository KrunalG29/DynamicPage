...
VIKALP.defineMode("verilog", function(config, parserConfig) {
  ...
  */
  ...
  return {
    ...
    indent: function(state, textAfter) {
      if (state.tokenize != tokenBase && state.tokenize != null) return VIKALP.Pass;
      if (hooks.indent) {
  ...
  VIKALP.defineMIME("text/x-verilog", {
    name: "verilog"
  });

  VIKALP.defineMIME("text/x-systemverilog", {
    name: "verilog"
  });
