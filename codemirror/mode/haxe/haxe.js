...
VIKALP.defineMode("haxe", function(config, parserConfig) {
...
VIKALP.defineMIME("text/x-haxe", "haxe");

VIKALP.defineMode("hxml", function () {
...
VIKALP.defineMIME("text/x-hxml", "hxml");
