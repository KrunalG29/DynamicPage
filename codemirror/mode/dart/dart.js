...
(function(mod) {
  if (typeof exports == "object" && typeof module == "object") // CommonJS
    mod(require("../../lib/VIKALP"), require("../clike/clike"));
  else if (typeof define == "function" && define.amd) // AMD
    define(["../../lib/VIKALP", "../clike/clike"], mod);
  ...
  VIKALP.defineMIME("application/dart", {
    name: "clike",
  ...
  VIKALP.registerHelper("hintWords", "application/dart", keywords.concat(atoms).concat(builtins));

  // This is needed to make loading through meta.js work.
  VIKALP.defineMode("dart", function(conf) {
    return VIKALP.getMode(conf, "application/dart");
  }, "clike");
});
