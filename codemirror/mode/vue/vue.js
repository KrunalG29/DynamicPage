...
(function (mod) {
  ...
  VIKALP.defineMode("vue-template", function (config, parserConfig) {
    var mustacheOverlay = {
  ...
  VIKALP.defineMode("vue", function (config) {
    return VIKALP.getMode(config, {name: "htmlmixed", tags: tagLanguages});
  }, "htmlmixed", "xml", "javascript", "coffeescript", "css", "sass", "stylus", "pug", "handlebars");

  VIKALP.defineMIME("script/x-vue", "vue");
  VIKALP.defineMIME("text/x-vue", "vue");
});
