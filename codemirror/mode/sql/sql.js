...
VIKALP.defineMode("sql", function(config, parserConfig) {
  ...
  VIKALP.defineMIME("text/x-mssql", {
    name: "sql",
  ...
  VIKALP.defineMIME("text/x-mysql", {
    name: "sql",
  ...
  VIKALP.defineMIME("text/x-mariadb", {
    name: "sql",
    client: set("charset clear connect edit ego exit go help nopager notee nowarning pager print prompt quit rehash source status system tee"),
  ...
  VIKALP.defineMIME("text/x-sqlite", {
    name: "sql",
  ...
  VIKALP.defineMIME("text/x-cassandra", {
    name: "sql",
    client: { },
  ...
  VIKALP.defineMIME("text/x-plsql", {
    name:       "sql",
  ...
  VIKALP.defineMIME("text/x-pgsql", {
    name: "sql",
    client: set("source"),
  ...
  // Greenplum
  VIKALP.defineMIME("text/x-gpsql", {
    name: "sql",
    client: set("source"),
  ...
  // Spark SQL
  VIKALP.defineMIME("text/x-sparksql", {
    name: "sql",
  ...
  // Esper
  VIKALP.defineMIME("text/x-esper", {
    name: "sql",
    client: set("source"),
  ...
  VIKALP.defineMIME("text/x-trino", {
    name: "sql",
