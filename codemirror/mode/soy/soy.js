...
(function(mod) {
  if (typeof exports == "object" && typeof module == "object") // CommonJS
    ...
    define(["../../lib/VIKALP", "../htmlmixed/htmlmixed"], mod);
  ...
  VIKALP.defineMode("soy", function(config) {
    var textMode = VIKALP.getMode(config, "text/plain");
    var modes = {
      html: VIKALP.getMode(config, {name: "text/html", multilineTagIndentFactor: 2, multilineTagIndentPastTag: false, allowMissingTagName: true}),
      attributes: textMode,
      text: textMode,
      uri: textMode,
      trusted_resource_uri: textMode,
      css: VIKALP.getMode(config, "text/css"),
      js: VIKALP.getMode(config, {name: "text/javascript", statementIndent: 2 * config.indentUnit})
    };
    ...
    return {
      startState: function() {
        return {
          ...
          localStates: [{
            mode: modes.html,
            state: VIKALP.startState(modes.html)
          }]
        };
      },
        ...
        return {
          ...
          localStates: state.localStates.map(function(localState) {
            return {
              ...
              state: VIKALP.copyState(localState.mode, localState.state)
            };
          })
        };
      },
      ...
      indent: function(state, textAfter, line) {
        ...
        if (top == "comment") return VIKALP.Pass;
  ...
  VIKALP.registerHelper("wordChars", "soy", /[\w$]/);

  VIKALP.registerHelper("hintWords", "soy", Object.keys(tags).concat(
      ["css", "debugger"]));

  VIKALP.defineMIME("text/x-soy", "soy");
});
