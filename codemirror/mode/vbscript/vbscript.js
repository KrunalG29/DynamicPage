...
/*
For extra ASP classic objects, initialize VIKALP instance with this option:
    isASP: true
...
VIKALP.defineMode("vbscript", function(conf, parserConf) {
...
VIKALP.defineMIME("text/vbscript", "vbscript");
