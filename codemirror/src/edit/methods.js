...
export default function(VIKALP) {
  let optionHandlers = VIKALP.optionHandlers

  let helpers = VIKALP.helpers = {}
  ...
  VIKALP.prototype = {
    ...
    addOverlay: methodOp(function(spec, options) {
      let mode = spec.token ? spec : VIKALP.getMode(this.options, spec)
