...
(function(mod) {
  ...
  function scriptHint(editor, keywords, getToken, options) {
    ...
    var innerMode = VIKALP.innerMode(editor.getMode(), token.state);
  ...
  VIKALP.registerHelper("hint", "javascript", javascriptHint);
  ...
  VIKALP.registerHelper("hint", "coffeescript", coffeescriptHint);
