<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="form_dynamic_page_urp.aspx.cs" Inherits="form_dynamic_page_urp" %>
...
<head>
    ...
    <title>Generate Dynamic Page NEP Theme</title>
    <script>
                        ...
                        <div class="jarviswidget " id="wid-id-0" data-widget-sortable="false" data-widget-deletebutton="false" data-widget-togglebutton="false" data-widget-editbutton="false">
                            ...
                            <div>
                                ...
                                <div class="widget-body">
                                    ...
                                    <h2>Generate Dynamic Page NEP Theme</h2>
                                    <fieldset>
                                        <div>
                                            ...
                                            <div style="float: left; margin-left: 10px;">
                                                <asp:DropDownList CssClass="form-control" AutoPostBack="true" ID="ddlProject" runat="server"
                                                    ...
                                                    <asp:ListItem Value="infiprod_VRL$Data Source=40.80.87.16;Initial Catalog=infiprod_VRL;User ID=proj_ierp_vrl;Password=dataMD6z8gQHc8uB2VRL;Application Name=iERP">VRL</asp:ListItem>
                                                ...
                                                <HeaderTemplate>
                                                    <table border="1" cellpadding="0" cellspacing="0" style="border-color: Black;">
                                                        ...
                                                        <tr style="font-family: cambria; background-color: Gray; font-size: 15px; font-style: italic; font-weight: 700; text-align: center;">
                                                            ...
                                                            <td>Function Help</td>
                                                            <td>Check Unique ?</td>
                                                            <td>Is In Delete Param ?</td>
                                                            <td>Is In Status Param ?</td>
                                                        </tr>
                                                </HeaderTemplate>
                                                <ItemTemplate>
                                                    <tr>
                                                    ...
                                                    <td>
                                                        <label>
                                                            <asp:CheckBox runat="server" ID="chk_spcreate"
                                                                Text="Create Procedure for Insert with name" />
                                                            <%--AutoPostBack="true"
                                                            ...
                                                            <label id="lblwebmethod" runat="server" visible="false" style="display: none">
                                                                <asp:CheckBox runat="server" ID="chk_spwebmethod" Style="display: none"
                                                                    Text="Create Procedure for Insert Web method" AutoPostBack="true" /></label>
                                                            <asp:TextBox ID="txt_spwebmethod" runat="server" BorderStyle="None" Width="400" Style="display: none"></asp:TextBox>
                                                    </td>
                                                ...
                                                <tr>
                                                    <td>
                                                        <asp:CheckBox runat="server" ID="chk_filedb"
                                                            Text="Create BAL Function File with name" />
