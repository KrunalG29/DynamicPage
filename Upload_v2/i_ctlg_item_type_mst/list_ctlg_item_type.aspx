<%@ Page Language="C#" MasterPageFile="~/Include/Master/site.master" AutoEventWireup="true"
    CodeFile="list_ctlg_item_type.aspx.cs" Inherits="list_ctlg_item_type" %>
   ...
   <!-- widget grid -->
    ...
    function Defchange(item) {
        ...
        var viewLog = function (event) {
            ...
            if(dataRecord.id !="")
            {
                $.ajax({
                    ...
                    url: "ajax_ctlg.aspx",
                    async: true,
                    data: "slv_itm_id="+dataRecord.id+"&sign=",
                    success: function (data) {
                        if (data.toString() != '') 
                        {                                    
        ...
        var Editclick = function (event) {
            ...
            $.ajax({
                type: "POST",
                url: "list_ctlg_item_type.aspx/Edit_",
                data: '{itm_id : "' + dataRecord.id + '" }',
        ...
        var Viewclick = function (event) {
            ...
            $.ajax({
                type: "POST",
                url: "list_ctlg_item_type.aspx/View_",
                data: '{itm_id: "' + dataRecord.id + '"}',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                beforeSend: function () {
        ...
        var Deleteclick = function (event) {
            ...
            if (confirm("Are you sure delete?")) {
                ...
                $.ajax({
                    ...
                    url: "ajax_ctlg.aspx",
                    async: true,
                    data: "del_itm_id=" + dataRecord.id + "&sign=",
                    success: function (data) {
                        if (data.toString() == '1') {
...
{ name: 'itm_parent_type', type: 'string', colName: 'TextBox 0' },
{ name: 'itm_name', type: 'string', colName: 'TextBox 2' },
{ name: 'itm_code', type: 'number', colName: 'TextBox 4' },
{ name: 'itm_is_system', type: 'date', colName: 'TextBox 6' },
{ name: 'itm_key', type: 'string', colName: 'TextBox 8' },
...
{ name: 'itm_key', type: 'string', colName: 'TextBox 8' }],
        ...
        function GetDataAJAX()
        {
            $.ajax({
                ...
                url: "ajax_ctlg.aspx",
                async: true,
                data: "gitm_user_id=<%=Session["user_id"]%>&sign=",
                success: function (data) {
                    if (data.toString() != '') 
                    {                                    
                        datafields = data;                                    
            ...
            $("#jqxgrid").jqxGrid(
            {
                ...
                rendertoolbar: function (toolbar) {
                    ...
                    addButton.click(function (event) {
                        window.location.href = "form_ctlg_item_type.aspx";
                    });
                    // Export In Excel
                    ...
                    deletedLogButton.click(function (event) {
                        ...
                        $.ajax({
                            ...
                            url: "ajax_ctlg.aspx",
                            async: true,
                            data: "dlv_itm_user_id=<%=Session["user_id"]%>&sign=",
                            success: function (data) {
                                if (data.toString() != '') 
                                {                                    
                                    datafieldsViewLog = data;                                    
...
{ text: 'TextBox 0', datafield: 'itm_parent_type',filtertype: 'input' },
{ text: 'TextBox 2', datafield: 'itm_name',filtertype: 'input' },
{ text: 'TextBox 4', datafield: 'itm_code',filtertype: 'number' },
{ text: 'TextBox 6', datafield: 'itm_is_system',filtertype: 'range' },
{ text: 'TextBox 8', datafield: 'itm_key',filtertype: 'input' },
