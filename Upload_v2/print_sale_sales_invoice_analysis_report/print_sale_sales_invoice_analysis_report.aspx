<%@ Page Title=" Language="C#" MasterPageFile="~/Include/Master/site.master" AutoEventWireup ="true" CodeBehind ="print_sale_sales_invoice_analysis_report.aspx.cs" Inherits ="print_sale_sales_invoice_analysis_report" %>
                    ...
                    <div class="row" >
                        ...
                        <ajaxToolkit:MaskedEditValidator ID="MaskedEditValidator_to_date" IsValidEmpty="true" runat="server"
                         ...
                         InvalidValueMessage="Date not valid" >
                              ...
                              <div class="col-md-4">
                                                 <asp:TextBox ID="txt_customer_group"  CssClass="form-control"  runat="server" PlaceHolder="Type And Select "Customer Group></asp:TextBox>
                        <ajaxToolkit:AutoCompleteExtender FirstRowSelected="true" ID="AutoCompleteExtender_customer_group" runat="server" ServicePath="~/Web_Services.asmx"
                        ServiceMethod="get_customer_group" TargetControlID="txt_customer_group" MinimumPrefixLength="1"
