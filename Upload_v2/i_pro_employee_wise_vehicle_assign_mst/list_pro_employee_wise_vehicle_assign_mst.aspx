<%@ Page Language="C#" MasterPageFile="~/Include/Master/list.master" AutoEventWireup="true"
    CodeFile="list_pro_employee_wise_vehicle_assign_mst.aspx.cs" Inherits="list_pro_employee_wise_vehicle_assign_mst" %>
    ...
    <!-- widget grid -->
						...
						<article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
							...
							<div class="jarviswidget jarviswidget-color-blueDark" id="wid-id-3" data-widget-sortable="false"  data-widget-deletebutton="false" data-widget-togglebutton="false" data-widget-editbutton="false">								
								<header>
									...
									<h2>employee_wise_vehicle_assign_mst</h2>				
								</header>				
								    <!-- widget div-->                                    
                                    <div>
        ...
        function SaveDef()
        {
            ...
            if(flg==0)
            {
                ...
                var DatStr={'uwgs_set_name':$("#txtDefName").val(),'uwgs_grid_name':'employee_wise_vehicle_assign_mst','uwgs_grid_state':JSON.stringify(stat)}
        ...
        var viewLog = function (event) {
            ...
            if(dataRecord.id !="")
            {
                $.ajax({
                    ...
                    url: "ajax_pro.aspx",
                    async: true,
                    data: "slv_ewvam_id="+dataRecord.id+"&sign=employee_wise_vehicle_assign_mst",
                    success: function (data) {
                        if (data.toString() != '') 
                        {                                    
        ...
        var Editclick = function (event)
        {
            var id = event.target.id;
            var dataRecord = $("#jqxgrid").jqxGrid('getrowdata', id);
            window.location.href = "form_pro_employee_wise_vehicle_assign.aspx?id=" + dataRecord.id;
        }
        var Deleteclick = function (event) {
            ...
            ConfirmBox("Are You Sure?","Do you want to delete this record?").done(function(){
                $.ajax({
                    ...
                    url: "ajax_pro.aspx",
                    async: true,
                    data: "del_ewvam_id=" + dataRecord.id+"&sign=employee_wise_vehicle_assign_mst",
                    success: function (data) {
                        if (data.toString() == '1') {
                            alert('employee_wise_vehicle_assign_mst deleted successfully.');
...
{ name: 'ewvam_emp_id', type: '', colName: '' },
{ name: 'ewvam_veh_id', type: '', colName: '' },
{ name: 'ewvam_date', type: '', colName: '' },
{ name: 'ewvam_cur_km', type: '', colName: '' },
{ name: 'ewvam_updated_km', type: '', colName: '' },
...
{ name: 'ewvam_updated_km', type: '', colName: '' }],
        ...
        function GetDataAJAX()
        {
            $.ajax({
                ...
                url: "ajax_pro.aspx",
                async: true,
                data: "gewvam_user_id=<%=Session["user_id"]%>&sign=employee_wise_vehicle_assign_mst",
                success: function (data) {
                    if (data.toString() != '') 
                    {                                    
                        datafields = data;                                    
        ...
        function GetDefData()
        {
            ...
            $.ajax({
                ...
                url: "<%=Session["base_url"]%>ajax_comm.aspx",
                async: false,
                data: "GridDef_user_id=<%=Session["user_id"]%>&Grid_name=employee_wise_vehicle_assign_mst",
                success: function (data) {
                    if (data.toString() != '') 
                    {                                    
            ...
            $("#jqxgrid").jqxGrid(
            {
                ...
                rendertoolbar: function (toolbar) {
                    ...
                    addButton.click(function (event) {
                        window.location.href = "form_pro_employee_wise_vehicle_assign.aspx";
                    });
                    // Export In Excel
                    ExportBtn.click(function (event) 
                    {
                        $("#jqxgrid").jqxGrid('exportdata', 'xls', 'employee_wise_vehicle_assign_mst_Detail');
                    });
                    //Deleted Log
                    deletedLogButton.click(function (event) {
                        ...
                        $.ajax({
                            ...
                            url: "ajax_pro.aspx",
                            async: true,
                            data: "dlv_ewvam_user_id=<%=Session["user_id"]%>&sign=employee_wise_vehicle_assign_mst",
                            success: function (data) {
                                if (data.toString() != '') 
                                {                                    
                                    datafieldsViewLog = data;                                    
...
{ text: '', datafield: 'ewvam_emp_id',filtertype: '' },
{ text: '', datafield: 'ewvam_veh_id',filtertype: '' },
{ text: '', datafield: 'ewvam_date',filtertype: '' },
{ text: '', datafield: 'ewvam_cur_km',filtertype: '' },
{ text: '', datafield: 'ewvam_updated_km',filtertype: '' },
