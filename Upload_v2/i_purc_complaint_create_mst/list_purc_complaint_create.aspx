<%@ Page Language="C#" MasterPageFile="~/Include/Master/list.master" AutoEventWireup="true"
    CodeFile="list_purc_complaint_create.aspx.cs" Inherits="list_purc_complaint_create" %>
    ...
    <!-- widget grid -->
        ...
        function SaveDef()
        {
            ...
            if(flg==0)
            {
                ...
                var DatStr={'uwgs_set_name':$("#txtDefName").val(),'uwgs_grid_name':'ComplaintCreate','uwgs_grid_state':JSON.stringify(stat)}
        ...
        var viewLog = function (event) {
            ...
            if(dataRecord.id !="")
            {
                $.ajax({
                    ...
                    url: "ajax_purc.aspx",
                    async: true,
                    data: "slv_ccm_id="+dataRecord.id+"&sign=ComplaintCreate",
                    success: function (data) {
                        if (data.toString() != '') 
                        {                                    
        ...
        var Editclick = function (event)
        {
            var id = event.target.id;
            var dataRecord = $("#jqxgrid").jqxGrid('getrowdata', id);
            window.location.href = "form_purc_complaint_create.aspx?id=" + dataRecord.id;
        }
        var Deleteclick = function (event) {
            ...
            ConfirmBox("Are You Sure?","Do you want to delete this record?").done(function(){
                $.ajax({
                    ...
                    url: "ajax_purc.aspx",
                    async: true,
                    data: "del_ccm_id=" + dataRecord.id+"&sign=ComplaintCreate",
                    success: function (data) {
                        if (data.toString() == '1') {
                            alert('ComplaintCreate deleted successfully.');
...
{ name: 'ccm_complaint_no', type: '', colName: '' },
{ name: 'ccm_date', type: '', colName: '' },
{ name: 'ccm_person_name', type: '', colName: '' },
{ name: 'ccm_department', type: '', colName: '' },
{ name: 'ccm_mobileno', type: '', colName: '' },
{ name: 'ccm_location', type: '', colName: '' },
{ name: 'ccm_complain_type', type: '', colName: '' },
{ name: 'ccm_sub_type', type: '', colName: '' },
{ name: 'ccm_remarks', type: '', colName: '' },
{ name: 'ccm_original_file', type: '', colName: '' },
{ name: 'ccm_sys_file', type: '', colName: '' },
...
{ name: 'ccm_sys_file', type: '', colName: '' }],
        ...
        function GetDataAJAX()
        {
            $.ajax({
                ...
                url: "ajax_purc.aspx",
                async: true,
                data: "gccm_user_id=<%=Session["user_id"]%>&sign=ComplaintCreate",
                success: function (data) {
                    if (data.toString() != '') 
                    {                                    
                        datafields = data;                                    
        ...
        function GetDefData()
        {
            ...
            $.ajax({
                ...
                url: "<%=Session["base_url"]%>ajax_comm.aspx",
                async: false,
                data: "GridDef_user_id=<%=Session["user_id"]%>&Grid_name=ComplaintCreate",
                success: function (data) {
                    if (data.toString() != '') 
                    {                                    
            ...
            $("#jqxgrid").jqxGrid(
            {
                ...
                rendertoolbar: function (toolbar) {
                    ...
                    addButton.click(function (event) {
                        window.location.href = "form_purc_complaint_create.aspx";
                    });
                    // Export In Excel
                    ExportBtn.click(function (event) 
                    {
                        $("#jqxgrid").jqxGrid('exportdata', 'xls', 'ComplaintCreate_Detail');
                    });
                    //Deleted Log
                    deletedLogButton.click(function (event) {
                        ...
                        $.ajax({
                            ...
                            url: "ajax_purc.aspx",
                            async: true,
                            data: "dlv_ccm_user_id=<%=Session["user_id"]%>&sign=ComplaintCreate",
                            success: function (data) {
                                if (data.toString() != '') 
                                {                                    
                                    datafieldsViewLog = data;                                    
...
{ text: '', datafield: 'ccm_complaint_no',filtertype: '' },
{ text: '', datafield: 'ccm_date',filtertype: '' },
{ text: '', datafield: 'ccm_person_name',filtertype: '' },
{ text: '', datafield: 'ccm_department',filtertype: '' },
{ text: '', datafield: 'ccm_mobileno',filtertype: '' },
{ text: '', datafield: 'ccm_location',filtertype: '' },
{ text: '', datafield: 'ccm_complain_type',filtertype: '' },
{ text: '', datafield: 'ccm_sub_type',filtertype: '' },
{ text: '', datafield: 'ccm_remarks',filtertype: '' },
{ text: '', datafield: 'ccm_original_file',filtertype: '' },
{ text: '', datafield: 'ccm_sys_file',filtertype: '' },
