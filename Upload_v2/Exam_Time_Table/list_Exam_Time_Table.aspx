<%@ Page Language="C#" MasterPageFile="~/Include/Master/list.master" AutoEventWireup="true"
    CodeFile="list_Exam_Time_Table.aspx.cs" Inherits="list_Exam_Time_Table" %>
    ...
    <!-- widget grid -->
        ...
        var viewLog = function (event) {
            ...
            if(dataRecord.id !="")
            {
                $.ajax({
                    ...
                    url: "ajax_Time.aspx",
                    async: true,
                    data: "slv_ett_id="+dataRecord.id+"&sign=",
                    success: function (data) {
                        if (data.toString() != '') 
                        {                                    
        ...
        var Editclick = function (event)
        {
            var id = event.target.id;
            var dataRecord = $("#jqxgrid").jqxGrid('getrowdata', id);
            window.location.href = "form_Exam_Time_Table.aspx?id=" + dataRecord.id;
        }
        var Deleteclick = function (event) {
            ...
            ConfirmBox("Are You Sure?","Do you want to delete this record?").done(function(){
                $.ajax({
                    ...
                    url: "ajax_Time.aspx",
                    async: true,
                    data: "del_ett_id=" + dataRecord.id+"&sign=",
                    success: function (data) {
                        if (data.toString() == '1') {
...
{ name: 'ett_Id', type: 'string', colName: 'TextBox 0' },
{ name: 'ett_Institute_Id', type: 'string', colName: 'TextBox 2' },
{ name: 'ett_Faculty_Id', type: 'number', colName: 'TextBox 4' },
{ name: 'ett_Program_Id', type: 'date', colName: 'TextBox 6' },
{ name: 'ett_Semester_Id', type: 'string', colName: 'TextBox 8' },
{ name: 'ett_Exam_Id', type: 'string', colName: 'TextBox 10' },
{ name: 'ett_Gap_Day', type: 'string', colName: 'TextBox 12' },
{ name: 'ett_Seq_No', type: 'string', colName: 'TextBox 14' },
{ name: 'ett_Component_Id', type: 'string', colName: 'TextBox 16' },
{ name: 'ett_Session_Id', type: 'string', colName: 'TextBox 18' },
{ name: 'ett_Exam_Date', type: 'number', colName: 'TextBox 20' },
{ name: 'ett_Exam_Start_Time', type: 'date', colName: 'TextBox 22' },
{ name: 'ett_Exam_End_Time', type: 'string', colName: 'TextBox 24' },
{ name: 'ett_Sub_Type_Id', type: 'string', colName: 'TextBox 26' },
{ name: 'ett_Is_Status', type: 'string', colName: 'TextBox 28' },
{ name: 'ett_Is_Delete', type: 'string', colName: 'TextBox 30' },
{ name: 'ett_Created_By', type: 'string', colName: 'TextBox 32' },
{ name: 'ett_Created_Date', type: 'string', colName: 'TextBox 34' },
{ name: 'ett_Created_Ip', type: 'number', colName: 'TextBox 36' },
{ name: 'ett_Modify_By', type: 'date', colName: 'TextBox 38' },
{ name: 'ett_Modify_Date', type: 'string', colName: 'TextBox 40' },
{ name: 'ett_Modify_Ip', type: 'string', colName: 'TextBox 42' },
{ name: 'ett_Deleted_By', type: 'string', colName: 'TextBox 44' },
{ name: 'ett_Deleted_Date', type: 'string', colName: 'TextBox 46' },
{ name: 'ett_Deleted_Ip', type: 'string', colName: 'TextBox 48' },
...
{ name: 'ett_Deleted_Ip', type: 'string', colName: 'TextBox 48' }],
        ...
        function GetDataAJAX()
        {
            $.ajax({
                ...
                url: "ajax_Time.aspx",
                async: true,
                data: "gett_user_id=<%=Session["user_id"]%>&sign=",
                success: function (data) {
                    if (data.toString() != '') 
                    {                                    
                        datafields = data;                                    
            ...
            $("#jqxgrid").jqxGrid(
            {
                ...
                rendertoolbar: function (toolbar) {
                    ...
                    addButton.click(function (event) {
                        window.location.href = "form_Exam_Time_Table.aspx";
                    });
                    // Export In Excel
                    ...
                    deletedLogButton.click(function (event) {
                        ...
                        $.ajax({
                            ...
                            url: "ajax_Time.aspx",
                            async: true,
                            data: "dlv_ett_user_id=<%=Session["user_id"]%>&sign=",
                            success: function (data) {
                                if (data.toString() != '') 
                                {                                    
                                    datafieldsViewLog = data;                                    
...
{ text: 'TextBox 0', datafield: 'ett_Id',filtertype: 'input' },
{ text: 'TextBox 2', datafield: 'ett_Institute_Id',filtertype: 'input' },
{ text: 'TextBox 4', datafield: 'ett_Faculty_Id',filtertype: 'number' },
{ text: 'TextBox 6', datafield: 'ett_Program_Id',filtertype: 'range' },
{ text: 'TextBox 8', datafield: 'ett_Semester_Id',filtertype: 'input' },
{ text: 'TextBox 10', datafield: 'ett_Exam_Id',filtertype: 'input' },
{ text: 'TextBox 12', datafield: 'ett_Gap_Day',filtertype: 'input' },
{ text: 'TextBox 14', datafield: 'ett_Seq_No',filtertype: 'input' },
{ text: 'TextBox 16', datafield: 'ett_Component_Id',filtertype: 'input' },
{ text: 'TextBox 18', datafield: 'ett_Session_Id',filtertype: 'input' },
{ text: 'TextBox 20', datafield: 'ett_Exam_Date',filtertype: 'number' },
{ text: 'TextBox 22', datafield: 'ett_Exam_Start_Time',filtertype: 'range' },
{ text: 'TextBox 24', datafield: 'ett_Exam_End_Time',filtertype: 'input' },
{ text: 'TextBox 26', datafield: 'ett_Sub_Type_Id',filtertype: 'input' },
{ text: 'TextBox 28', datafield: 'ett_Is_Status',filtertype: 'input' },
{ text: 'TextBox 30', datafield: 'ett_Is_Delete',filtertype: 'input' },
{ text: 'TextBox 32', datafield: 'ett_Created_By',filtertype: 'input' },
{ text: 'TextBox 34', datafield: 'ett_Created_Date',filtertype: 'input' },
{ text: 'TextBox 36', datafield: 'ett_Created_Ip',filtertype: 'number' },
{ text: 'TextBox 38', datafield: 'ett_Modify_By',filtertype: 'range' },
{ text: 'TextBox 40', datafield: 'ett_Modify_Date',filtertype: 'input' },
{ text: 'TextBox 42', datafield: 'ett_Modify_Ip',filtertype: 'input' },
{ text: 'TextBox 44', datafield: 'ett_Deleted_By',filtertype: 'input' },
{ text: 'TextBox 46', datafield: 'ett_Deleted_Date',filtertype: 'input' },
{ text: 'TextBox 48', datafield: 'ett_Deleted_Ip',filtertype: 'input' },
