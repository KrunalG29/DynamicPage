<%@ Page Language="C#" MasterPageFile="~/Include/Master/list.master" AutoEventWireup="true"
    CodeFile="list_pro_tyre.aspx.cs" Inherits="list_pro_tyre" %>
    ...
    <!-- widget grid -->
        ...
        var viewLog = function (event) {
            ...
            if(dataRecord.id !="")
            {
                $.ajax({
                    ...
                    url: "ajax_pro.aspx",
                    async: true,
                    data: "slv_tm_id="+dataRecord.id+"&sign=",
                    success: function (data) {
                        if (data.toString() != '') 
                        {                                    
        ...
        var Editclick = function (event)
        {
            var id = event.target.id;
            var dataRecord = $("#jqxgrid").jqxGrid('getrowdata', id);
            window.location.href = "form_pro_tyre.aspx?id=" + dataRecord.id;
        }
        var Deleteclick = function (event) {
            ...
            ConfirmBox("Are You Sure?","Do you want to delete this record?").done(function(){
                $.ajax({
                    ...
                    url: "ajax_pro.aspx",
                    async: true,
                    data: "del_tm_id=" + dataRecord.id+"&sign=",
                    success: function (data) {
                        if (data.toString() == '1') {
...
{ name: 'tm_veh_id', type: 'number', colName: '' },
{ name: 'tm_veh_no', type: 'number', colName: '' },
{ name: 'tm_ojm_id', type: 'date', colName: 'Scrap Date' },
{ name: 'tm_no', type: 'string', colName: 'Tyre Txn No' },
{ name: 'tm_seq_id', type: 'string', colName: 'Vehicle No' },
{ name: 'tm_itm_id', type: 'string', colName: 'Serial No' },
{ name: 'tm_uom_id', type: 'string', colName: 'Item Name' },
{ name: 'tm_position_id', type: 'string', colName: 'Scrap Location' },
{ name: 'tm_condition_id', type: 'string', colName: 'Reason' },
{ name: 'tm_is_itm_wise', type: '', colName: '' },
{ name: 'tm_sr_no', type: '', colName: '' },
{ name: 'tm_date', type: '', colName: '' },
{ name: 'is_without_jobcard', type: '', colName: '' },
{ name: 'tm_dcm_id', type: '', colName: '' },
{ name: 'tm_loc_id', type: '', colName: '' },
{ name: 'tm_cup_id', type: '', colName: '' },
{ name: 'tm_cell_id', type: '', colName: '' },
...
{ name: 'tm_cell_id', type: '', colName: '' }],
        ...
        function GetDataAJAX()
        {
            $.ajax({
                ...
                url: "ajax_pro.aspx",
                async: true,
                data: "gtm_user_id=<%=Session["user_id"]%>&sign=",
                success: function (data) {
                    if (data.toString() != '') 
                    {                                    
                        datafields = data;                                    
            ...
            $("#jqxgrid").jqxGrid(
            {
                ...
                rendertoolbar: function (toolbar) {
                    ...
                    addButton.click(function (event) {
                        window.location.href = "form_pro_tyre.aspx";
                    });
                    // Export In Excel
                    ...
                    deletedLogButton.click(function (event) {
                        ...
                        $.ajax({
                            ...
                            url: "ajax_pro.aspx",
                            async: true,
                            data: "dlv_tm_user_id=<%=Session["user_id"]%>&sign=",
                            success: function (data) {
                                if (data.toString() != '') 
                                {                                    
                                    datafieldsViewLog = data;                                    
...
{ text: '', datafield: 'tm_veh_id',filtertype: 'number' },
{ text: '', datafield: 'tm_veh_no',filtertype: 'number' },
{ text: 'Scrap Date', datafield: 'tm_ojm_id',filtertype: 'range' },
{ text: 'Tyre Txn No', datafield: 'tm_no',filtertype: 'input' },
{ text: 'Vehicle No', datafield: 'tm_seq_id',filtertype: 'input' },
{ text: 'Serial No', datafield: 'tm_itm_id',filtertype: 'input' },
{ text: 'Item Name', datafield: 'tm_uom_id',filtertype: 'input' },
{ text: 'Scrap Location', datafield: 'tm_position_id',filtertype: 'input' },
{ text: 'Reason', datafield: 'tm_condition_id',filtertype: 'input' },
{ text: '', datafield: 'tm_is_itm_wise',filtertype: '' },
{ text: '', datafield: 'tm_sr_no',filtertype: '' },
{ text: '', datafield: 'tm_date',filtertype: '' },
{ text: '', datafield: 'is_without_jobcard',filtertype: '' },
{ text: '', datafield: 'tm_dcm_id',filtertype: '' },
{ text: '', datafield: 'tm_loc_id',filtertype: '' },
{ text: '', datafield: 'tm_cup_id',filtertype: '' },
{ text: '', datafield: 'tm_cell_id',filtertype: '' },
