<%@ Page Title=" Language="C#" MasterPageFile="~/Include/Master/site.master" AutoEventWireup ="true" CodeBehind ="print_pro_tyre_issue_report_vrl.aspx.cs" Inherits ="print_pro_tyre_issue_report_vrl" %>
                    ...
                    <div class="row" >
                        ...
                        <ajaxToolkit:MaskedEditValidator ID="MaskedEditValidator_to_date" IsValidEmpty="true" runat="server"
                         ...
                         InvalidValueMessage="Date not valid" >
                                        ...
                                        <div class="form-group">                           <section class="col col-6">                                                
                              <label class="col-md-2 control-label" >
                                                Item Code With Name</label>
                              <div class="col-md-4">
                                                 <asp:TextBox ID="txt_tyre_name"  CssClass="form-control"  runat="server" PlaceHolder="Type And Select "Item Code With Name></asp:TextBox>
                        <ajaxToolkit:AutoCompleteExtender FirstRowSelected="true" ID="AutoCompleteExtender_tyre_name" runat="server" ServicePath="~/Web_Services.asmx"
                        ServiceMethod="get_item_name_by_LikeName_ItemType_and_Flag" TargetControlID="txt_tyre_name" MinimumPrefixLength="1"
                        ...
                        CompletionListItemCssClass="itemsMain" UseContextKey="true" ContextKey=" ">
                              ...
                              <label class="col-md-2 control-label" >
                                                Vehicle No</label>
                              <div class="col-md-4">
                                                 <asp:TextBox ID="txt_vehicle_no"  CssClass="form-control"  runat="server" PlaceHolder="Type And Select "Vehicle No></asp:TextBox>
                        <ajaxToolkit:AutoCompleteExtender FirstRowSelected="true" ID="AutoCompleteExtender_vehicle_no" runat="server" ServicePath="~/Web_Services.asmx"
                        ServiceMethod="get_vehicle_reg_no" TargetControlID="txt_vehicle_no" MinimumPrefixLength="1"
                        CompletionListCssClass="listMain" EnableCaching="false" CompletionListHighlightedItemCssClass="itemsSelected"
                        CompletionListItemCssClass="itemsMain" UseContextKey="true" ContextKey=" ">
                        </ajaxToolkit:AutoCompleteExtender>
                                                </div>
