<%@ Page Title=" Language="C#" MasterPageFile="~/Include/Master/site.master" AutoEventWireup ="true" CodeBehind ="print_pro_line_wise_maintenance_cost_report.aspx.cs" Inherits ="print_pro_line_wise_maintenance_cost_report" %>
                    ...
                    <div class="row" >
                        ...
                        <ajaxToolkit:MaskedEditValidator ID="MaskedEditValidator_to_date" IsValidEmpty="true" runat="server"
                         ...
                         InvalidValueMessage="Date not valid" >
                              ...
                              <label class="col-md-2 control-label" >
                                                To Date</label>
                              <div class="col-md-4">
                                                 <asp:TextBox ID="txt_line"  CssClass="form-control"  runat="server" PlaceHolder="Type And Select "To Date></asp:TextBox>
                        <ajaxToolkit:AutoCompleteExtender FirstRowSelected="true" ID="AutoCompleteExtender_line" runat="server" ServicePath="~/Web_Services.asmx"
                        ServiceMethod="get_itemcode" TargetControlID="txt_line" MinimumPrefixLength="1"
                        ...
                        CompletionListItemCssClass="itemsMain" UseContextKey="true" ContextKey=" ">
                              ...
                              <label class="col-md-2 control-label" >
                                                To Date</label>
                              <div class="col-md-4">
                                                 <asp:TextBox ID="txt_machine"  CssClass="form-control"  runat="server" PlaceHolder="Type And Select "To Date></asp:TextBox>
                        <ajaxToolkit:AutoCompleteExtender FirstRowSelected="true" ID="AutoCompleteExtender_machine" runat="server" ServicePath="~/Web_Services.asmx"
                        ServiceMethod="get_itemcode" TargetControlID="txt_machine" MinimumPrefixLength="1"
                        CompletionListCssClass="listMain" EnableCaching="false" CompletionListHighlightedItemCssClass="itemsSelected"
                        CompletionListItemCssClass="itemsMain" UseContextKey="true" ContextKey=" ">
                        </ajaxToolkit:AutoCompleteExtender>
                                                </div>
