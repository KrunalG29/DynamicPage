...
public partial class print_store_stock_report_TEST : COMM_SessionCheck
{
    ...
    protected void Page_Init(object sender, EventArgs e)
    {
        ...
        rpt_file = db_conf_report_configuration_mst.Get_rpt_file_name("print_store_stock_report_TEST.aspx", 1, Handle.ToInt32(Session["comp_id"]));
        if (String.IsNullOrEmpty(rpt_file))
        {
            rpt_file = "print_store_stock_report_TEST.rpt";
        }
        int exportFormatFlag = DAL_Utilities.allowExportFormats();
        CrystalReportViewer1.AllowedExportFormats = exportFormatFlag;
        CrystalReportSource1.Report.FileName = Session["BASE_DIR"] + "store/reports/" + rpt_file.Trim();
        FileName = "";
    }
    #endregion
    ...
    public void bind_data()
    {
        ...
        CrystalReportSource1.Report.FileName = Session["BASE_DIR"] + "store/reports/gfpl/" + rpt_file;
