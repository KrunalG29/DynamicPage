...
public partial class print_sale_sales_return_assembly_report : COMM_SessionCheck
{
    ...
    protected void Page_Init(object sender, EventArgs e)
    {
        ...
        rpt_file = db_conf_report_configuration_mst.Get_rpt_file_name("print_sale_sales_return_assembly_report.aspx", 1, Handle.ToInt32(Session["comp_id"]));
        if (String.IsNullOrEmpty(rpt_file))
        {
            rpt_file = "print_sale_sales_return_assembly_report.rpt";
        }
