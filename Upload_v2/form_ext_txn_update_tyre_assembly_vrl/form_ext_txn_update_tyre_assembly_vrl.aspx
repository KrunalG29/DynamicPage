<%@ Page Title=" Language="C#" MasterPageFile="~/Include/Master/site.master" AutoEventWireup ="true" CodeBehind ="form_ext_txn_update_tyre_assembly_vrl.aspx.cs" Inherits ="form_ext_txn_update_tyre_assembly_vrl" %>
                    ...
                    <div class="row" >
                        ...
                        <div class="jarviswidget" id ="wid-id-0" data-widget-sortable="false" data-widget-deletebutton="false" data-widget-togglebutton="false" data-widget-editbutton="false" >
                            ...
                            <div>
                              ...
                              <label class="col-md-2 control-label" >
                                                Item Code</label>
                              <div class="col-md-4">
                                                 <asp:TextBox ID="txt_tyre_no"  CssClass="form-control"  runat="server" PlaceHolder="Type And Select "Item Code></asp:TextBox>
                        <ajaxToolkit:AutoCompleteExtender FirstRowSelected="true" ID="AutoCompleteExtender_tyre_no" runat="server" ServicePath="~/Web_Services.asmx"
                        ServiceMethod="get_itemcode" TargetControlID="txt_tyre_no" MinimumPrefixLength="1"
                        ...
                        CompletionListItemCssClass="itemsMain" UseContextKey="true" ContextKey=" ">
                              ...
                              <label class="col-md-2 control-label" >
                                                Item Code</label>
                              <div class="col-md-4">
                                                 <asp:TextBox ID="txt_assembly_no"  CssClass="form-control"  runat="server" PlaceHolder="Type And Select "Item Code></asp:TextBox>
                        <ajaxToolkit:AutoCompleteExtender FirstRowSelected="true" ID="AutoCompleteExtender_assembly_no" runat="server" ServicePath="~/Web_Services.asmx"
                        ServiceMethod="get_itemcode" TargetControlID="txt_assembly_no" MinimumPrefixLength="1"
                        CompletionListCssClass="listMain" EnableCaching="false" CompletionListHighlightedItemCssClass="itemsSelected"
                        CompletionListItemCssClass="itemsMain" UseContextKey="true" ContextKey=" ">
                        </ajaxToolkit:AutoCompleteExtender>
                                                </div>
