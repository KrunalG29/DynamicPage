...
public partial class form_acct_account_bill_to_bill_adjustment : COMM_SessionCheck
{
    ...
    protected void Page_Init(object sender, EventArgs e)
    {
        ...
        rpt_file = db_conf_report_configuration_mst.Get_rpt_file_name("form_acct_account_bill_to_bill_adjustment.aspx", 1, Handle.ToInt32(Session["comp_id"]));
        if (String.IsNullOrEmpty(rpt_file))
        {
            rpt_file = "form_acct_account_bill_to_bill_adjustment.rpt";
        }
        int exportFormatFlag = DAL_Utilities.allowExportFormats();
        CrystalReportViewer1.AllowedExportFormats = exportFormatFlag;
        CrystalReportSource1.Report.FileName = Session["BASE_DIR"] + "acct/reports/" + rpt_file.Trim();
        FileName = "";
    }
    #endregion
    ...
    public void bind_data()
    {
        ...
        CrystalReportSource1.Report.FileName = Session["BASE_DIR"] + "acct/reports/gfpl/" + rpt_file;
